...
func TestSimpleUnionFind_Connected(t *testing.T) {
	uf := NewSimpleUnionFind(3)
...
func TestSimpleUnionFind_Find(t *testing.T) {
	uf := NewSimpleUnionFind(5)
	...
	assert.Equal(t, 1, uf[3], "Find should perform path compression")
	assert.Equal(t, 1, uf[2], "Find should perform path compression")
}

func TestSimpleUnionFind_Union(t *testing.T) {
	uf := NewSimpleUnionFind(5)
